...
type LineOrderTab struct {
	...
	GoodsType     uint64  `gorm:"column:goods_type;type:int(11);NOT NULL" json:"goods_type"`
	...
	PackageHeight uint64  `gorm:"column:package_height;type:int(11);default:0" json:"package_height"`
	PackageWeight uint64  `gorm:"column:package_weight;type:int(11);default:0" json:"package_weight"`
	Price         float64 `gorm:"column:price;type:decimal(10,4)" json:"price"`
	OrderStatus   uint64  `gorm:"column:order_status;type:tinyint(4);NOT NULL" json:"order_status"`
	LineId        uint64  `gorm:"column:line_id;type:int(11);NOT NULL" json:"line_id"`
	LaneOrderId   uint64  `gorm:"column:lane_order_id;type:bigint(20)" json:"lane_order_id"`
	CreateTime    uint    `gorm:"column:create_time;type:int(11);NOT NULL" json:"create_time"`
	UpdateTime    uint    `gorm:"column:update_time;type:int(11);NOT NULL" json:"update_time"`
}
